...
typedef struct
{
    ...
    uint8 ownAddrType;       // Address type of owner device, 2024-05-15 add (case for SMP SC )
    uint8 ownAddr[B_ADDR_LEN];  // Owner Device's address, 2024-05-15 add (case for SMP SC )
} linkDBItem_t;
