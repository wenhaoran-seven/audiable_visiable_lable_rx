...
#define BLE_CONN_LL_DEV_LIST_SIZE       (MAX_CONNECTION_NUM*(6+1+1))
#endif
//// Multi-role Event
...
#define MULTI_PERIOD_TIMING             50     //ms
...
typedef void (*gapRolesScanDone_t)(void);
