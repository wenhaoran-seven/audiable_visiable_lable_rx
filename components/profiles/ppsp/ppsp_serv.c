...
bStatus_t ppsp_serv_set_para( uint8 para, void* valu, uint16 leng )
{
    ...
    {
        uint16 cfgs = GATTServApp_ReadCharCfg( ota_conHandle, __ppsp_serv_char_ffd6_cfgs );
    ...
    {
        uint16 cfgs = GATTServApp_ReadCharCfg( ota_conHandle, __ppsp_serv_char_ffd8_cfgs );
